...
def evaluate_metrics():
    ...
    prec_score = precision_score(y_test, decision_tree_predictions, average='weighted')
    r_score = recall_score(y_test, decision_tree_predictions, average='weighted')
    fscore = f1_score(y_test, decision_tree_predictions, average='weighted')
    print("accuracy score of decision tree: %.5f" % acc)
    print("precision score of decision tree: %.5f" % prec_score)
    print("recall score of decision tree: %.5f" % r_score)
    print("f score of decision tree: %.5f" % fscore)
...
def plot_observation():
    ...
    decision_tree_predict = decision_tree_predictions[:200]
    plt.xlabel('X(Time->)')
    ...
    plt.savefig('confusion_decisionTree.png')
